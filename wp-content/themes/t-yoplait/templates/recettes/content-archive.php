...
<?php 
    $tax_ingredient = get_terms('tax_ingredient', array('hide_empty' => false));
    $tax_modele = get_terms('tax_modele', array('hide_empty' => false));
?>
<section class="kl-section-recettes-list">
    <div class="container kl-max-w-xl-1038 mt-5">
        <form role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
            <input type="search" class="search-field"
                placeholder="<?php echo esc_attr_x( 'Rechercher des recettes…', 'placeholder' ) ?>"
                value="<?php echo get_search_query() ?>" name="s"
                title="<?php echo esc_attr_x( 'Recherche pour:', 'label' ) ?>" />
            <input type="hidden" name="post_type" value="recette" />
            <!-- This line makes sure we're only searching 'recette' post types -->
            <button type="submit" class="search-submit">
                <img src="<?php bloginfo('template_directory'); ?>/assets/img/icon/search.svg" class="img-fluid" alt="">
            </button>
        </form>

        <div class="kl-recettes-filtre kl-max-w-345 kl-max-w-md-none mx-auto">
            <form action="" id="id-filter-form" method="POST">
                <input type="hidden" name="paged" value="1">
                <!-- <div class="row kl-gx-xl-30 kl-gy-30">
                    <div class="col-md-6">
                        <div class="kl-max-w-md-287 mx-md-auto">
                            <div class="custom-dropdown" data-control="checkbox-dropdown">
                                <label class="custom-dropdown-label">Afficher les recettes :</label>
                                <div class="custom-dropdown-list">
                                    <a href="#" data-toggle="check-all" class="custom-dropdown-option d-none">
                                        Sélectionner tout
                                    </a>
                                    <div>
                                        <?php
                                            // if ( $tax_modele ) :
                                            //     foreach ( $tax_modele as $cat ) :
                                            ?>
                                                <div class="form-check kl-form-check kl-form-check-square js-modele">
                                                <input class="form-check-input kl-form-check-input js-chexbox-type-recette" type="checkbox" value="<?php // echo $cat->term_id; ?>" id="id-type-<?php // echo $cat->term_id; ?>" name="modele[]">
                                                    <label class="form-check-label kl-form-check-label" for="id-type-<?php // echo $cat->term_id; ?>"><?php // echo $cat->name; ?></label>
                                                </div>
                                            <?php // endforeach; 
                                            // endif;
                                        ?>
                    ...
                    <div class="col-md-6">
                        <div class="kl-max-w-md-287 ms-md-auto">
                            <select id="id-select-ingredients" name="ingredients" class="kl-dropdown-select js-ingredients">
                                <option></option>
                                <?php
                                    // if ( $tax_ingredient ) :
                                        // foreach ( $tax_ingredient as $cat ) :
                                    ?>
                            ...
                            <div id="id-select-ingredients-dropdown" class="kl-dropdown-parent"></div>
                        </div>
                    </div>
                </div> -->
            </form>
        ...
        <div class="kl-max-w-345 kl-max-w-md-none mx-auto filtered-posts">
            ...
            <div id="pagination">
                ...
                <nav class="d-flex justify-content-center align-items-center pb-5"
                    aria-label="Page navigation recettes">
                    <div class="d-none d-md-inline-block kl-text-page">
                        <span>Page</span>
                    </div>
                    <?php
                            $big = 999999999;
                            ...
                            $listString = paginate_links( array(
                                ...
                                'type'  => 'list',
                                'prev_text' => '<svg class="mb-1" width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.09597 1.52903C7.21801 1.65107 7.21801 1.84893 7.09597 1.97097L3.56694 5.5L7.09597 9.02903C7.21801 9.15107 7.21801 9.34893 7.09597 9.47097C6.97393 9.59301 6.77607 9.59301 6.65403 9.47097L2.90403 5.72097C2.78199 5.59893 2.78199 5.40107 2.90403 5.27903L6.65403 1.52903C6.77607 1.40699 6.97393 1.40699 7.09597 1.52903Z" fill="#3675B7"/>
                                                </svg> ',
                                'next_text' => '<svg class="mb-1" width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M2.90403 1.52903C2.78199 1.65107 2.78199 1.84893 2.90403 1.97097L6.43306 5.5L2.90403 9.02903C2.78199 9.15107 2.78199 9.34893 2.90403 9.47097C3.02607 9.59301 3.22393 9.59301 3.34597 9.47097L7.09597 5.72097C7.21801 5.59893 7.21801 5.40107 7.09597 5.27903L3.34597 1.52903C3.22393 1.40699 3.02607 1.40699 2.90403 1.52903Z" fill="#3675B7"/>
                                                </svg> '
                            ) );
                                
                            
                            $listString = str_replace("<ul class='page-numbers'>", '<ul class="kl-pagination pagination mb-0">', $listString);
